<template>
  <nav>
    <div :class="['navbar fixed min-h-14 z-100',
      scrolled ? 'bg-base-300/85 text-base-content/85 shadow-lg border-b border-b-base-content/20 navbar--backdrop-blur'
      : 'bg-transparent text-neutral-content/85']">
      <div class="max-w-8xl inline-flex grow mx-auto">
        <div class="navbar-start flex-1 lg:flex-initial mx-3">
          <div class="dropdown dropdown-start lg:hidden mr-3">
            ...
            <div tabindex="-1" class="dropdown-content">
              <ul class="menu menu-lg bg-base-300/75 text-base-content backdrop-blur-md text-shadow-sm w-26 mt-4 items-center rounded-box z-100 shadow-2xl ">
                <li><a>归档</a></li>
                <li><a>分类</a></li>
                <li><a>标签</a></li>
                <li><a>动态</a></li>
        ...
        <div class="navbar-end flex-0 lg:flex-initial mx-3">
          <div class="dropdown dropdown-end dropdown-hover group/menu-btn">
            <div tabindex="0" role="button" class="nav__btn nav__icon-btn">
              <svg :class="['nav__icon', currentTheme === 'default' ? 'block' : 'hidden']" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 24 24">
              ...
              <svg :class="['nav__icon', currentTheme === 'light' ? 'block' : 'hidden']" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 24 24">
              ...
              <svg :class="['nav__icon', currentTheme === 'dark' ? 'block' : 'hidden']" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 24 24">
            ...
            <div tabindex="-1" class="dropdown-content hidden group-hover/menu-btn:block">
              <ul class="menu menu-md gap-1 w-35 bg-base-300/75 backdrop-blur-md rounded-box z-100 shadow-2xl mt-4">
                <li @click="currentTheme = 'default'">
                  <label :class="['nav__theme-option-btn', {'nav__theme-option-btn--active': currentTheme === 'default'}]">
                    ...
                    <input
                      type="radio"
                      name="theme-dropdown"
                      class="theme-controller appearance-none"
                      :value="usePreferredColorScheme().value" />
                    <span>跟随系统</span>
                  </label>
                </li>
                <li @click="currentTheme = 'light'">
