...
const navClass = computed(() => {
  // TODO 这里在亮色模式下 动画持续时间 设长了（400ms以上）会产生肉眼可见的闪烁，有空看一下，没空就算了，应该不会用时间这么长的过渡，影响不大
  const classList = ['navbar', 'top-0', 'min-h-15', 'border-b', 'z-100', 'transition', 'duration-200','p-0']
